function packed_hmm = pack1DHMM(tr1, tr2, em1, em2)
  states1 = size(tr1, 1);
  states2 = size(tr2, 1);
  ...
  packed_hmm(1,1)= states1;
  packed_hmm(2,1) = states2;
  packed_hmm(3,1) = emissions1;
  packed_hmm(4,1) = emissions2;
  
  packed_hmm(1:states1, 2:1+states1) = tr1;
  packed_hmm(1:states2, 2+states1:1+states1+states2) = tr2;

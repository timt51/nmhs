...
% is not provided.
%
% Let tr1 be NxNxM and tr2 be MxMxN. Then:
% average = a single number between 0 and 1 that describes "averaging over 
%           all states, how much does neuron1 depend on neuron 2"
...
%               how much does it depend on neuron 2"
...
if average ~= mean(perNeighborStatePair) %sanity check
    error('Error calculating means') 
end

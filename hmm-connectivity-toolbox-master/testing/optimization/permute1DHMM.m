function new_model = permute1DHMM(optimValues, problem_data)
...
function new_model = neighbor(new_model)
  [tr1, tr2, em1, em2] = unpack1DHMM(new_model);
  states1 = size(tr1, 1);
  states2 = size(tr2, 1);
  emissions1 = size(em1, 1);
  emissions2 = size(em2, 1);
  
  num_vals = (states1*states1) + (states2*states2) + ...
  ...
  new_model = pack1DHMM(tr1, tr2, em1, em2);
end

function [tr1_trained, tr2_trained, em1_trained, em2_trained] = ...
    anneal2DHMM(tr1_guess, tr2_guess, em1_guess, em2_guess, seq1, seq2, varargin)
%  args:
...
[guess1D, time_limit, func_evals] = optargs{:};
...
options = saoptimset('DataType', 'custom', 'AnnealingFcn', @permute2DHMM, ...
    'MaxFunEvals', func_evals, 'TimeLimit', time_limit);
...
begin = cputime;
try
    trained_model = simulannealbnd(@(model, data)hmm_fitness(model, {seq1, seq2}), packed_model, [], [], options);
catch exc

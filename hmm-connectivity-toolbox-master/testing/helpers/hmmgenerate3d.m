...
% hmmtrain3d. Works similar to hmmgenerate2d. There is a crucial difference which is that dimensions 1 and 2 are transposed, so that state indices can be read as [to, from, from, from]
%
%

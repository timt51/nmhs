% Hodgkin-Huxley circuit model implemented by Leif Gibb 6/28/15 through 11/27/15

function ydot = hh_ode(t,y,Nneur,Nsyn,time,Iin,gsyn)
    ...
    ydot = [udot(1); mdot(1); ndot(1); hdot(1); udot(2); mdot(2); ndot(2); hdot(2); udot(3); mdot(3); ndot(3); hdot(3); rdot(1); rdot(2)];
